...
<body>
    <div class="admin_page">
        <div class="left_admin_page">
            <a class="laptop_homepage_logo_link" href="${pageContext.request.contextPath}">
            ...
            <a href="" class="left_list_item active">
                <i class="fa-solid fa-user"></i>
                Tài khoản quản lý
            </a>
            <a href="" class="left_list_item left_list_item_logout">
                Đăng xuất
            </a>
        </div>
        <div class="right_admin_page">
            ...
            <div class="right_admin_table_list">
            	<h3 class="deleteLaptopSuccess">${editUserSuccessOk }</h3>
            	<h3 class="deleteLaptopSuccess">${deleteUserSuccessOk }</h3>
                <a href="admin_user_dashboard_add" class="add-user-btn">
                    <button type="button" class="btn btn-success create-restaurant-btn">
                ...
                <table class="table table_user_list list_restaurant">
                    ...
                    <tbody class="body_restaurant">
                    		<tr class="hover-item-restaurant">
	                            <th scope="row">${adminUser.getId() }</th>
                        ...
                        <c:forEach items="${listUser}" var="user">
		                     <tr class="hover-item-restaurant">
	                            ...
	                            <td>${user.getRole() }</td>
	                            <td><a href="admin_user_dashboard_edit?id=${user.getId() }"><i class="bi bi-pencil-square"></i></a></td>
	                            <td><a href="admin_user_dashboard_delete?id=${user.getId() }"><i class="bi bi-trash"></i></a></td>
	                        </tr>
		                 </c:forEach>
