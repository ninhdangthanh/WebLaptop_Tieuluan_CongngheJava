...
<script>
    document.getElementById('trademark_name').onchange = function () {
        ...
        if (selectedValue == "Dell") {
            document.getElementById("series").innerHTML = "<option value='Latitude'>Latitude</option><option value='Inspiron'>Inspiron</option><option value='Vostro'>Vostro</option>"
        } else if (selectedValue == "Acer") {
            document.getElementById("series").innerHTML = "<option value='Aspire'>Aspire</option><option value='Nitro'>Nitro</option><option value='Swift'>Swift</option>"
        } else {
            document.getElementById("series").innerHTML = "<option value='Zenbook'>Zenbook</option><option value='VivoBook'>VivoBook</option><option value='ROG'>ROG</option>"
        }
