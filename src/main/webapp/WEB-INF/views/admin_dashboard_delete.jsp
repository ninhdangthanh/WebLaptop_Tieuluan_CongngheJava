...
<head>
    ...
    <title>Delete ${laptopDelete.getName() }</title>
</head>
    ...
    <div class="admin_page">
        ...
        <div class="right_admin_page">
            ...
            <div class="right_list_form">
                <img class="img_product_delete_page"
                    src="${laptopDelete.link_img}" alt="">
                <h2>${laptopDelete.getName() }</h2>
                <a href="admin_dashboard_delete_confirm?id=${laptopDelete.getId()}" type="button" class="btn btn-danger">Xác nhận xóa</a>
            </div>
        </div>
    </div>
</body>
