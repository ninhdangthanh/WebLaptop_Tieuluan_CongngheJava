...
<body>
    <div class="admin_page">
        ...
        <div class="right_admin_page">
            ...
            <h3 class="add_product_success">${addUserStatus }</h3>
                <form action="${pageContext.request.contextPath}/admin_user_edit" method="post">
                    <input hidden value="${userEdit.getId() }" type="text" placeholder="Nhập Email" class="form-control"
                            name="id" id="id">
					<input hidden value="${userEdit.getEmail() }" type="text" placeholder="Nhập Email" class="form-control"
                            name="email" id="email">
                    <div class="mb-3">
                        <label class="form-label"><strong>Email</strong></label>
                        <input disabled value="${userEdit.getEmail() }" minlength="14" required="" type="text" placeholder="Nhập Email" class="form-control"
                            name="email" id="email">
                    </div>
                    <div class="mb-3">
