        ...
        <div class="right_admin_page">
            <div class="right_admin_page_header">
                ...
                <div class="search_header w-25">
        			<form  action="${pageContext.request.contextPath}/admin_dashboard" method="post" class="search_header_wrap">
                        <input class="search_header_input" id="searchingPageAdmin" name="searchingPageAdmin" type="text"
            ...
            <div class="right_list_product">
                <c:forEach items="${LaptopInAdminPage}" var="laptop">
                     <div href="" class="list_product_item">
	                    ...
	                    <div class="list_product_item_title"> ${laptop.getName()}</div>
	                    <div class="list_product_item_manipulate">
	                        <a class="list_product_item_button list_product_item_edit" href="admin_dashboard_edit?id=${laptop.getId()}">Edit</a>
	                        <a class="list_product_item_button list_product_item_delete" href="admin_dashboard_delete?id=${laptop.getId()}">Delete</a>
	                    </div>
	                </div>
                 </c:forEach>
            </div>
