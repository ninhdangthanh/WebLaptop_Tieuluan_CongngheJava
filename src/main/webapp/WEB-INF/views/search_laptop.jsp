        ...
        <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
            ...
            <body>
                ...
                <div class="body_search container">
                    ...
                    <h5 class="body_search_content">Kết quả tìm kiếm cho dell E5300</h5>
                </div>

                <div class="body_laptop_products container">
                    <div class="body_products_item_right_item">
                        <img src="https://cdn.tgdd.vn/Products/Images/44/244384/dell-g3-15-i7-p89f002g3500c-600x600.jpg"
                            alt="">
