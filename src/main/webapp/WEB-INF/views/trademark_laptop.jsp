    ...
    <%@ page language="java" %>
        <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
            ...
            <head>
                ...
                <title>LapTop ${trademarkLaptopName}</title>
            </head>
            ...
            <body>
                ...
                <div class="body_title container">
                    <div class="body_nav">
                        ...
                        /
                        <span>Laptop ${trademarkLaptopName}</span>
                    </div>

                    <div class="body_banner">
                        <div>
                            <img src="https://laptop-react-web.web.app/static/media/bannerL.e6450bdf.jpg" alt="">
                        </div>
                        <div>
                            <img src="https://laptop-react-web.web.app/static/media/bannerR.cc2029f7.jpg" alt="">
                        </div>
                    </div>

                    <h2 class="body_laptop_title">Laptop ${trademarkLaptopName }</h2>

                    <div class="body_laptop_type">
                        <a href="${listSeriesHref.get(0)}" id="${listSeries.get(0)}"
                            class="body_laptop_type_item">${listSeries.get(0)}</a>
                        <a href="${listSeriesHref.get(1)}" id="${listSeries.get(1)}"
                            class="body_laptop_type_item">${listSeries.get(1)}</a>
                        <a href="${listSeriesHref.get(2)}" id="${listSeries.get(2)}"
                            class="body_laptop_type_item">${listSeries.get(2)}</a>
                    </div>
                </div>

                <div class="body_laptop_products container">
                    <c:forEach items="${trademarkLaptop}" var="laptop">
            ...
            <script>
                ...
                const seriesValue = url.searchParams.get('series');
                const trademarkValue = url.searchParams.get('trademark');
                if (seriesValue) {
                    var str = trademarkValue + " " + seriesValue;
                    var seriesElements = document.getElementById(str)
                    seriesElements.classList.add("series_active");
                }
            </script>