...
public class Laptop {
	...
	public Laptop(int id, String name, String price, int price_real, String series, String past_price, String cpu,
			String cpu_compact, String ram, String ram_compact, String memory_compact, String card, String screen,
			String screen_compact, String link_img, String trademark_id) {
		super();
		this.id = id;
		this.name = name;
		this.price = price;
	...
	public String toString() {
		return "Laptop [id=" + id + ", name=" + name + ", price=" + price + ", price_real=" + price_real + ", series="
				+ series + ", past_price=" + past_price + ", cpu=" + cpu + ", cpu_compact=" + cpu_compact + ", ram="
				+ ram + ", ram_compact=" + ram_compact + ", memory_compact=" + memory_compact + ", card=" + card
				+ ", screen=" + screen + ", screen_compact=" + screen_compact + ", link_img=" + link_img
